...
const THEMES = [
  ...
  { id: 'hiphop',   label: 'Hip-Hop 90s',  emoji: '🎤', tracks: [
    ...
    {a:'Run-DMC',t:'Walk This Way'},{a:'Rakim',t:"Don't Sweat the Technique"},
    {a:'KRS-One',t:'Sound of da Police'},{a:'Method Man',t:'Bring the Pain'},
    {a:'Gang Starr',t:'Mass Appeal'},{a:'Slick Rick',t:"Children's Story"},
    {a:'Salt-N-Pepa',t:'Shoop'},{a:'Cypress Hill',t:'Insane in the Brain'},
    {a:'Public Enemy',t:'Fight the Power'},{a:'Ice-T',t:'Colors'},
  ]},
  { id: 'disco',    label: 'Disco',         emoji: '🪩', tracks: [
    ...
    {a:'The Trammps',t:'Disco Inferno'},{a:'Village People',t:'Y.M.C.A.'},
    ...
    {a:'Heatwave',t:'Boogie Nights'},{a:'Anita Ward',t:'Ring My Bell'},
    {a:'Rose Royce',t:"Wishing on a Star"},
    {a:'A Taste of Honey',t:'Boogie Oogie Oogie'},
    {a:'Evelyn King',t:'Shame'},{a:'Odyssey',t:'Native New Yorker'},
  ...
  { id: 'edm',      label: 'EDM / Electro', emoji: '🎧', tracks: [
    ...
    {a:'Zedd',t:'Clarity'},{a:'Marshmello',t:'Alone'},
    {a:'Eric Prydz',t:'Call on Me'},{a:'Above & Beyond',t:'Sun & Moon'},
    {a:'Armin van Buuren',t:'Blah Blah Blah'},{a:'Fatboy Slim',t:'Praise You'},
    {a:'Underworld',t:'Born Slippy'},{a:'The Prodigy',t:'Breathe'},
    {a:'Pendulum',t:'Showdown'},{a:'Nero',t:'Promises'},
  ]},
  { id: 'soul',     label: 'Soul / Motown', emoji: '🌟', tracks: [
    ...
    {a:'Isley Brothers',t:"It's Your Thing"},{a:'Commodores',t:'Easy'},
    {a:'Earth Wind & Fire',t:'September'},{a:'Lionel Richie',t:'All Night Long'},
    {a:'Roberta Flack',t:'Killing Me Softly'},{a:'Bill Withers',t:'Lean on Me'},
    {a:'O\'Jays',t:'Love Train'},{a:'Edwin Starr',t:'War'},
    {a:'Chaka Khan',t:"Ain't Nobody"},{a:'Marvelettes',t:'Please Mr. Postman'},
    {a:'Mary Wells',t:'My Guy'},{a:'Impressions',t:'People Get Ready'},
    {a:'Sly & The Family Stone',t:'Everyday People'},
    {a:'Wilson Pickett',t:'Mustang Sally'},{a:'Gladys Knight',t:'Midnight Train to Georgia'},
  ]},
  ...
  { id: 'anime',    label: 'Anime',         emoji: '⛩️', artistLabel:'Anime', answerMode: 'title-only', singleLabel: 'Anime / Show', tracks: [
    ...
    {a:'Man with a Mission',t:'Raise Your Flag',src:'Gundam Iron-Blooded Orphans'},
  ...
  { id: 'jazz',     label: 'Jazz',          emoji: '🎷', tracks: [
    ...
    {a:'Billie Holiday',t:'Strange Fruit'},{a:'Charlie Parker',t:'Ornithology'},
    {a:'Dizzy Gillespie',t:'A Night in Tunisia'},{a:'Sonny Rollins',t:'St. Thomas'},
    {a:'Stan Getz',t:'The Girl from Ipanema'},{a:'Freddie Hubbard',t:'Red Clay'},
    {a:'Sarah Vaughan',t:'Misty'},{a:'Nat King Cole',t:'Unforgettable'},
  ...
  { id: 'classical',label: 'Classical',     emoji: '🎻', answerMode: 'title-only', singleLabel: 'Piece Name', tracks: [
    ...
    {a:'Liszt',t:'La Campanella'},{a:'Ravel',t:'Boléro'},
    {a:'Stravinsky',t:'The Rite of Spring'},{a:'Sibelius',t:'Finlandia'},
    {a:'Dvořák',t:'Symphony No. 9 New World'},{a:'Elgar',t:'Enigma Variations'},
    {a:'Holst',t:'The Planets Mars'},{a:'Orff',t:'O Fortuna'},
    {a:'Barber',t:'Adagio for Strings'},{a:'Prokofiev',t:'Romeo and Juliet'},
  ]},
  { id: 'country',  label: 'Country',       emoji: '🤠', tracks: [
    ...
    {a:'George Strait',t:'Amarillo by Morning'},{a:'Tim McGraw',t:'Live Like You Were Dying'},
    {a:'Alan Jackson',t:'Chattahoochee'},{a:'Reba McEntire',t:'Fancy'},
    {a:'Brooks & Dunn',t:'Boot Scootin\' Boogie'},{a:'Trisha Yearwood',t:'She\'s in Love with the Boy'},
    {a:'Vince Gill',t:'When I Call Your Name'},{a:'Toby Keith',t:"Should've Been a Cowboy"},
    {a:'Keith Urban',t:"You'll Think of Me"},{a:'Dierks Bentley',t:'Come a Little Closer'},
    {a:'Jason Aldean',t:'Big Green Tractor'},{a:'Blake Shelton',t:'God Gave Me You'},
    {a:'Luke Bryan',t:'Play It Again'},{a:'Florida Georgia Line',t:'Cruise'},
  ]},
  { id: 'christmas',label: 'Christmas 🎄',  emoji: '🎅', tracks: [
    ...
    {a:'Eartha Kitt',t:'Santa Baby'},{a:'Kelly Clarkson',t:'Underneath the Tree'},
    {a:'Justin Bieber',t:'Mistletoe'},{a:'Burl Ives',t:'Have a Holly Jolly Christmas'},
  ...
  { id: 'latin',    label: 'Latin Pop',      emoji: '💃', tracks: [
    ...
    {a:'Juan Gabriel',t:'Amor Eterno'},{a:'Selena',t:'Bidi Bidi Bom Bom'},
    {a:'Luis Miguel',t:'La Incondicional'},{a:'Romeo Santos',t:'Propuesta Indecente'},
    {a:'Becky G',t:'SHOWER'},{a:'Nicky Jam',t:'El Amante'},
    {a:'Farruko',t:'Pepas'},
  ]},
  ...
  { id: 'grunge',   label: 'Grunge',          emoji: '🎸', tracks: [
    ...
    {a:'Lemonheads',t:'Into Your Arms'},{a:'The Breeders',t:'Cannonball'},
    {a:'Pavement',t:'Cut Your Hair'},{a:'Meat Puppets',t:'Backwater'},
  ...
  { id: 'newwave',  label: 'New Wave',         emoji: '📼', tracks: [
    ...
    {a:'Human League',t:"Don't You Want Me"},{a:'Soft Cell',t:'Tainted Love'},
    {a:'Ultravox',t:'Vienna'},{a:'Howard Jones',t:'New Song'},
    {a:'A Flock of Seagulls',t:'I Ran'},{a:'The Cars',t:'Just What I Needed'},
    {a:'OMD',t:'Enola Gay'},{a:'Japan',t:'Ghosts'},
    {a:'Squeeze',t:'Up the Junction'},{a:'The Pretenders',t:'Brass in Pocket'},
  ]},
  { id: 'afrobeats',label: 'Afrobeats',        emoji: '🌍', tracks: [
    ...
    {a:'Burna Boy',t:'Last Last'},{a:'Wizkid',t:"Fever"},
    {a:'Rema',t:'Calm Down'},{a:'Tems',t:'Free Mind'},
    {a:'Ayra Starr',t:'Rush'},{a:'Asake',t:'Joha'},
    {a:'CKay',t:'Love Nwantiti'},{a:'Fireboy DML',t:'Peru'},
    {a:'Omah Lay',t:'Understand'},{a:'Oxlade',t:'KU LO SA'},
    {a:'Kizz Daniel',t:'Buga'},{a:'Victony',t:'Soweto'},
    {a:'Ruger',t:'Dior'},{a:'Diamond Platnumz',t:'Jeje'},
    {a:'Sauti Sol',t:'Suzanna'},{a:'Davido',t:'Stand Strong'},
  ]},
  ...
  { id: 'bollywood',label: 'Bollywood',        emoji: '🎭', tracks: [
    ...
    {a:'Badshah',t:'Paagal'},{a:'Guru Randhawa',t:'Slowly Slowly'},
    {a:'Sunidhi Chauhan',t:'Desi Girl'},{a:'Yo Yo Honey Singh',t:'Blue Eyes'},
  ...
  { id: 'bossa',    label: 'Bossa Nova',       emoji: '🌴', tracks: [
    ...
    {a:'Jorge Ben',t:'Mas Que Nada'},{a:'Elza Soares',t:'Negra Maluca'},
    {a:'Ivan Lins',t:'Madalena'},{a:'Gilberto Gil',t:'Aquele Abraço'},
  ...
  { id: 'punk',     label: 'Punk Rock',        emoji: '⚡', tracks: [
    ...
    {a:'Fugazi',t:'Waiting Room'},{a:'Minor Threat',t:'Straight Edge'},
    {a:'Bad Brains',t:'I Against I'},{a:'Bikini Kill',t:'Rebel Girl'},
    {a:'Sleater-Kinney',t:'Dig Me Out'},{a:'The Minutemen',t:'Corona'},
    {a:'X',t:'Los Angeles'},{a:'GBH',t:'Sick Boy'},
  ]},
  { id: 'rnb2000s', label: '2000s R&B',        emoji: '💎', tracks: [
    ...
    {a:'Brandy',t:'What About Us?'},{a:'Monica',t:'So Gone'},
    {a:'Eve',t:'Let Me Blow Ya Mind'},
    {a:'Mariah Carey',t:'Obsessed'},
    {a:'Fantasia',t:'I Believe'},{a:'Jordin Sparks',t:'No Air'},
    {a:'Keri Hilson',t:'Pretty Girl Rock'},
  ]},
  { id: 'hiphop2000s',label:'2000s Hip-Hop',   emoji: '🔥', tracks: [
    ...
    {a:'Fat Joe',t:'Lean Back'},{a:'Ja Rule',t:'Put It on Me'},
    {a:'Common',t:'The Light'},{a:'Mos Def',t:'Ms. Fat Booty'},
    {a:'Talib Kweli',t:'Get By'},{a:'Dead Prez',t:'Hip Hop'},
    {a:'Lil Jon',t:'Get Low'},{a:'Chingy',t:'Right Thurr'},
    {a:'Snoop Dogg',t:'Beautiful'},{a:'Rick Ross',t:'Push It'},
  ]},
  { id: 'current',  label: 'Current Hits',     emoji: '📱', tracks: [
    ...
    {a:'Noah Kahan',t:'Stick Season'},{a:'Teddy Swims',t:'Lose Control'},
    {a:'Jelly Roll',t:'Need a Favor'},{a:'Shaboozey',t:'A Bar Song'},
    {a:'Doechii',t:'Nissan Altima'},{a:"Chappell Roan",t:'Pink Pony Club'},
    {a:'Gracie Abrams',t:'Risk'},{a:"Måneskin",t:"Beggin'"},
  ]},
  { id: 'neosoul',  label: 'Neo-Soul',         emoji: '🕊️', tracks: [
    ...
    {a:'Raphael Saadiq',t:'Still Ray'},{a:'Anthony Hamilton',t:'Charlene'},
    {a:'Tweet',t:'Oops'},{a:'Floetry',t:'Say Yes'},
    {a:'Dwele',t:'Subject'},{a:'Toni Braxton',t:'He Wasn\'t Man Enough'},
    {a:'Thundercat',t:'Them Changes'},{a:'Steve Lacy',t:'Bad Habit'},
    {a:'Meshell Ndegeocello',t:'Bitter'},{a:'Lalah Hathaway',t:'Let Go'},
    {a:'Joe',t:'All That I Am'},{a:'Amel Larrieux',t:'Get Up'},
  ]},
  { id: 'funk',     label: 'Funk',             emoji: '🎺', tracks: [
    ...
    {a:'Con Funk Shun',t:'Ffun'},{a:'Bar-Kays',t:'Too Hot to Stop'},
    {a:'Lakeside',t:'Fantastic Voyage'},{a:'Dazz Band',t:'Let It Whip'},
    {a:'Midnight Star',t:'Freak-A-Zoid'},
    {a:'Club Nouveau',t:'Lean on Me'},{a:'Ready for the World',t:'Oh Sheila'},
  ...
  { id: 'blues',    label: 'Blues',            emoji: '🎸', tracks: [
    ...
    {a:'Freddie King',t:'The Stumble'},{a:'T-Bone Walker',t:'T-Bone Shuffle'},
    {a:'Junior Wells',t:'Hoodoo Man Blues'},{a:'Son House',t:'Death Letter'},
    {a:"Lightnin' Hopkins",t:'Mojo Hand'},{a:'Guitar Slim',t:'The Things That I Used to Do'},
  ...
  { id: 'musicals', label: 'Musicals',         emoji: '🎭', answerMode: 'title-only', singleLabel: 'Song or Musical', tracks: [
    ...
    {a:'In the Heights Original Cast',t:'96000'},
    {a:'Les Misérables Original Cast',t:'One Day More'},
    {a:'Cats Original Cast',t:'Memory'},
    {a:'Hadestown Original Cast',t:'Way Down Hadestown'},
  ...
  { id: 'tvthemes_classic',label:'Classic TV Themes',emoji:'📺', artistLabel:'Show', answerMode: 'title-only', singleLabel: 'Show Name', tracks: [
    ...
    {a:'Hugo Montenegro',t:'The Man from U.N.C.L.E. Theme'},
    {a:'Jerry Goldsmith',t:'The Waltons Theme'},
    {a:'Jerry Fielding',t:'The Mod Squad Theme'},
    {a:'Hoyt Curtin',t:'The Flintstones Theme'},
  ]},
  { id: 'tvthemes_modern',label:'Modern TV Themes',emoji:'🖥️', artistLabel:'Show', answerMode: 'title-only', singleLabel: 'Show Name', tracks: [
    ...
    {a:'Aimee Mann',t:'Wise Up (Magnolia)'},
    {a:'Bear McCreary',t:'Black Sails Theme'},
    {a:'Cliff Martinez',t:'Drive (Original Motion Picture Score)'},
    {a:'Explosions in the Sky',t:'Friday Night Lights Theme'},
    {a:'Trent Reznor',t:'Hand Covers Bruise (The Social Network)'},
    {a:'Yo La Tengo',t:'Freaks (Yo La Tengo Version)'},
  ...
  { id: '70s',      label: '70s Hits',         emoji: '🕺', tracks: [
    ...
    {a:'Kool & the Gang',t:'Jungle Boogie'},{a:'War',t:'Low Rider'},
    {a:'Three Dog Night',t:'Joy to the World'},
    {a:'America',t:'Horse with No Name'},
    {a:'Carole King',t:'I Feel the Earth Move'},
    {a:'Neil Young',t:'Heart of Gold'},
    {a:'Bruce Springsteen',t:'Born to Run'},
    {a:'Supertramp',t:'Dreamer'},
    {a:'Simon & Garfunkel',t:'The Sound of Silence'},
    {a:'Jackson Browne',t:'Running on Empty'},
    {a:'Roxy Music',t:'Love Is the Drug'},
  ]},
  { id: 'workout',  label: 'Workout / Gym',    emoji: '💪', tracks: [
    ...
    {a:'Black Eyed Peas',t:'Pump It'},{a:'Lil Jon',t:'Get Low'},
    {a:'Swedish House Mafia',t:"Don't You Worry Child"},
    {a:'Muse',t:'Uprising'},{a:'Queens of the Stone Age',t:'No One Knows'},
    {a:'Audioslave',t:'Like a Stone'},
    {a:'Bring Me the Horizon',t:'Can You Feel My Heart'},
    {a:'Pendulum',t:'Showdown'},{a:'Hardwell',t:'Spaceman'},
  ...
  { id: 'lofi',     label: 'Lo-fi / Chill',    emoji: '☕', tracks: [
    ...
    {a:'Washed Out',t:'Feel It All Around'},{a:'James Blake',t:'Retrograde'},
    {a:'Shlohmo',t:'Rained the Whole Time'},{a:'Baths',t:'Indoorsy'},
    {a:'Clams Casino',t:"I'm God"},{a:'Emancipator',t:'Soon It Will Be Cold Enough'},
    {a:'Thievery Corporation',t:'Richest Man in Babylon'},
    {a:'Toro y Moi',t:'Say That'},{a:'How to Dress Well',t:'And It Was U'},
  ]},
