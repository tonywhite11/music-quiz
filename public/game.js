...
const THEMES = [
  ...
  { id: "anime",    label: "Anime",         emoji: "⛩️", bpm: 128, artistLabel: "Anime", artistPlaceholder: "Which anime?", answerMode: "title-only", singleLabel: "Anime / Show", tracks: [
    ...
    { a: "JAM Project",              t: "SKILL",                 src: "Super Robot Wars" },
    { a: "Man with a Mission",       t: "Raise Your Flag",       src: "Mobile Suit Gundam Iron-Blooded Orphans" },
    { a: "Scandal",                  t: "Harukaze",              src: "Bleach" },
    { a: "BRADIO",                   t: "Flyers",                src: "Death Parade" },
    { a: "SiM",                      t: "The Rumbling",          src: "Attack on Titan Final Season" },
    { a: "Aimer",                    t: "Brave Shine",           src: "Fate/Stay Night" },
    { a: "Hiroshi Kitadani",         t: "We Are!",               src: "One Piece" },
    { a: "Stereopony",               t: "Hitohira no Hanabira",  src: "Bleach" },
  ]},
  { id: "jazz",     label: "Jazz",          emoji: "🎷", bpm: 120, tracks: [
    ...
    { a: "Billie Holiday",   t: "Strange Fruit" },
    { a: "Charlie Parker",   t: "Ornithology" },
    { a: "Dizzy Gillespie",  t: "A Night in Tunisia" },
    { a: "Sonny Rollins",    t: "St. Thomas" },
    { a: "Stan Getz",        t: "The Girl from Ipanema" },
    { a: "Freddie Hubbard",  t: "Red Clay" },
    { a: "Sarah Vaughan",    t: "Misty" },
    { a: "Keith Jarrett",    t: "The Koln Concert" },
    { a: "Pat Metheny",      t: "Phase Dance" },
    { a: "Nat King Cole",    t: "Unforgettable" },
  ]},
  { id: "videogames", label: "Jeux Vidéo", emoji: "🎮", bpm: 140, artistLabel: "Game", artistPlaceholder: "Which game?", answerMode: "title-only", singleLabel: "Game Name", tracks: [
    ...
    { a: "Jeremy Soule",     t: "Dragonborn",                src: "Skyrim" },
    { a: "Austin Wintory",   t: "Apotheosis",                src: "Journey" },
    { a: "Grant Kirkhope",   t: "Main Theme",                src: "Banjo-Kazooie" },
    { a: "David Wise",       t: "Aquatic Ambiance",          src: "Donkey Kong Country" },
    { a: "Inon Zur",         t: "Main Title Theme",          src: "Fallout 4" },
    { a: "Disasterpeace",    t: "Your Heart",                src: "Undertale" },
    { a: "Mick Gordon",      t: "BFG Division",              src: "Doom 2016" },
    { a: "Yuka Kitamura",    t: "Soul of Cinder",            src: "Dark Souls 3" },
  ]},
  { id: "films",    label: "Films",         emoji: "🎬", bpm: 100, artistLabel: "Movie", artistPlaceholder: "Which movie?", answerMode: "title-only", singleLabel: "Movie Title", tracks: [
    ...
    { a: "Ennio Morricone",  t: "Cinema Paradiso Theme",          src: "Cinema Paradiso" },
    { a: "Michael Giacchino", t: "Married Life",                  src: "Up" },
    { a: "Ludwig Göransson",   t: "Can You Hear the Music",        src: "Oppenheimer" },
    { a: "Ramin Djawadi",    t: "Main Title",                     src: "Game of Thrones" },
    { a: "James Horner",     t: "My Heart Will Go On",            src: "Titanic" },
    { a: "Thomas Newman",    t: "Any Other Name",                 src: "American Beauty" },
    { a: "John Barry",       t: "Born Free Theme",                src: "Born Free" },
    { a: "Jerry Goldsmith",  t: "The Omen Ave Satani",            src: "The Omen" },
  ]},
  { id: "soul",     label: "Soul / Motown", emoji: "🌟", bpm: 108, tracks: [
    ...
    { a: "Isley Brothers",   t: "It's Your Thing" },
    { a: "Commodores",       t: "Easy" },
    { a: "Earth Wind & Fire",t: "September" },
    { a: "Lionel Richie",    t: "All Night Long" },
    { a: "Roberta Flack",    t: "Killing Me Softly" },
    { a: "Lou Rawls",        t: "You'll Never Find Another Love Like Mine" },
    { a: "Bill Withers",     t: "Lean on Me" },
    { a: "Harold Melvin",    t: "If You Don't Know Me By Now" },
    { a: "O'Jays",           t: "Love Train" },
    { a: "Spinners",         t: "Could It Be I'm Falling in Love" },
    { a: "Chaka Khan",       t: "Ain't Nobody" },
    { a: "Rufus",            t: "Tell Me Something Good" },
    { a: "Edwin Starr",      t: "War" },
    { a: "Temptations",      t: "Papa Was a Rollin' Stone" },
    { a: "Marvelettes",      t: "Please Mr. Postman" },
    { a: "Mary Wells",       t: "My Guy" },
    { a: "Jr. Walker",       t: "Shotgun" },
    { a: "Impressions",      t: "People Get Ready" },
    { a: "Sly & The Family Stone", t: "Everyday People" },
    { a: "Booker T. & The MGs", t: "Green Onions" },
  ]},
  { id: "edm",      label: "Electro / EDM", emoji: "🎧", bpm: 128, tracks: [
    ...
    { a: "Zedd",             t: "Clarity" },
    { a: "Marshmello",       t: "Alone" },
    { a: "Kygo",             t: "Stole the Show" },
    { a: "Eric Prydz",       t: "Call on Me" },
    { a: "Above & Beyond",   t: "Sun & Moon" },
    { a: "Armin van Buuren", t: "Blah Blah Blah" },
    { a: "Fatboy Slim",      t: "Praise You" },
    { a: "Underworld",       t: "Born Slippy" },
    { a: "The Prodigy",      t: "Breathe" },
    { a: "Pendulum",         t: "Showdown" },
    { a: "Nero",             t: "Promises" },
  ]},
  { id: "latin",    label: "Latin Pop",     emoji: "💃", bpm: 95, tracks: [
    ...
    { a: "Bad Bunny",        t: "MIA" },
    { a: "Maluma",           t: "Corazón" },
    { a: "Juan Gabriel",     t: "Amor Eterno" },
    { a: "Selena",           t: "Bidi Bidi Bom Bom" },
    { a: "Luis Miguel",      t: "La Incondicional" },
    { a: "Juanes",           t: "La Camisa Negra" },
    { a: "Becky G",          t: "SHOWER" },
    { a: "Ozuna",            t: "Escp\u00e1pate Conmigo" },
    { a: "Nicky Jam",        t: "El Amante" },
    { a: "CNCO",             t: "Reggaet\u00f3n Lento" },
    { a: "Romeo Santos",     t: "Propuesta Indecente" },
    { a: "Farruko",          t: "Pepas" },
  ]},
  ...
  { id: "hiphop",   label: "Hip-Hop 90s",   emoji: "🎤", bpm: 90, tracks: [
    ...
    { a: "LL Cool J",        t: "Rock the Bells" },
    { a: "Run-DMC",          t: "Walk This Way" },
    { a: "Rakim",            t: "Paid in Full" },
    { a: "KRS-One",          t: "Sound of da Police" },
    { a: "Busta Rhymes",     t: "Put Your Hands Where My Eyes Could See" },
    { a: "Method Man",       t: "All I Need" },
    { a: "Gang Starr",       t: "Mass Appeal" },
    { a: "Slick Rick",       t: "Children's Story" },
    { a: "Salt-N-Pepa",      t: "Push It" },
    { a: "Cypress Hill",     t: "Insane in the Brain" },
    { a: "Public Enemy",     t: "Fight the Power" },
    { a: "Ice-T",            t: "6 'N the Mornin'" },
  ...
  { id: "disco",    label: "Disco",          emoji: "🪩", bpm: 120, tracks: [
    ...
    { a: "Sylvester",        t: "You Make Me Feel Mighty Real" },
    { a: "Thelma Houston",   t: "Don't Leave Me This Way" },
    { a: "Heatwave",         t: "Boogie Nights" },
    { a: "A Taste of Honey", t: "Boogie Oogie Oogie" },
    { a: "Evelyn King",      t: "Shame" },
    { a: "Anita Ward",       t: "Ring My Bell" },
    { a: "Rose Royce",       t: "Wishing on a Star" },
    { a: "Tavares",          t: "Heaven Must Be Missing an Angel" },
    { a: "Cerrone",          t: "Supernature" },
    { a: "Odyssey",          t: "Native New Yorker" },
    { a: "Patrick Hernandez", t: "Born to Be Alive" },
  ]},
  ...
  { id: "newwave",  label: "New Wave",        emoji: "📼", bpm: 115, tracks: [
    ...
    { a: "Soft Cell",        t: "Tainted Love" },
    { a: "Ultravox",         t: "Vienna" },
    { a: "Howard Jones",     t: "Things Can Only Get Better" },
    { a: "A Flock of Seagulls", t: "I Ran" },
    { a: "The Cars",         t: "Just What I Needed" },
    { a: "Orchestral Manoeuvres", t: "Enola Gay" },
    { a: "Japan",            t: "Ghosts" },
    { a: "Squeeze",          t: "Cool for Cats" },
    { a: "The Pretenders",   t: "Back on the Chain Gang" },
  ]},
  { id: "pop2020s", label: "2020s Pop",      emoji: "🚀", bpm: 118, tracks: [
    ...
    { a: "Glass Animals",    t: "Heat Waves" },
    { a: "Tate McRae",       t: "You Broke Me First" },
    { a: "Conan Gray",       t: "Heather" },
    { a: "Phoebe Bridgers",  t: "Garden Song" },
    { a: "Giveon",           t: "Heartbreak Anniversary" },
    { a: "Silk Sonic",       t: "Leave the Door Open" },
    { a: "Miley Cyrus",      t: "Flowers" },
    { a: "Doja Cat",         t: "Woman" },
    { a: "GAYLE",            t: "abcdefu" },
    { a: "Stephen Sanchez",  t: "Until I Found You" },
    { a: "PinkPantheress",   t: "Boy's a liar" },
    { a: "Måneskin",         t: "Beggin'" },
  ]},
  { id: "afrobeats", label: "Afrobeats",     emoji: "🌍", bpm: 100, tracks: [
    ...
    { a: "Asake",            t: "Organise" },
    { a: "Oxlade",           t: "Ku Lo Sa" },
    { a: "Kizz Daniel",      t: "Buga" },
    { a: "Victony",          t: "Soweto" },
    { a: "Ruger",            t: "Dior" },
    { a: "Diamond Platnumz", t: "Jeje" },
    { a: "Sauti Sol",        t: "Suzanna" },
  ]},
  { id: "classical", label: "Classical",     emoji: "🎻", bpm: 80, answerMode: "title-only", singleLabel: "Piece Name", tracks: [
    ...
    { a: "Liszt",            t: "La Campanella" },
    { a: "Ravel",            t: "Boléro" },
    { a: "Stravinsky",       t: "The Rite of Spring" },
    { a: "Sibelius",         t: "Finlandia" },
    { a: "Dvořák",           t: "Symphony No. 9 New World" },
    { a: "Elgar",            t: "Enigma Variations" },
    { a: "Holst",            t: "The Planets Mars" },
    { a: "Orff",             t: "O Fortuna" },
    { a: "Barber",           t: "Adagio for Strings" },
    { a: "Prokofiev",        t: "Romeo and Juliet" },
  ]},
  { id: "indie",    label: "Indie Folk",     emoji: "🌿", bpm: 88, tracks: [
    ...
    { a: "Death Cab for Cutie", t: "I Will Follow You into the Dark" },
    { a: "Postal Service",    t: "Such Great Heights" },
    { a: "The Shins",         t: "New Slang" },
    { a: "Wolf Parade",       t: "I'll Believe in Anything" },
    { a: "Neutral Milk Hotel", t: "In the Aeroplane Over the Sea" },
    { a: "Elliott Smith",     t: "Between the Bars" },
    { a: "Nick Drake",        t: "Pink Moon" },
    { a: "Band of Horses",    t: "The Funeral" },
    { a: "Phosphorescent",    t: "Song for Zula" },
    { a: "Damien Rice",       t: "The Blower's Daughter" },
    { a: "Iron & Wine",       t: "Flightless Bird" },
    { a: "Gillian Welch",     t: "Everything Is Free" },
  ]},
  { id: "country",  label: "Country",        emoji: "🤠", bpm: 92, tracks: [
    ...
    { a: "George Strait",    t: "Carrying Your Love with Me" },
    { a: "Tim McGraw",       t: "Live Like You Were Dying" },
    { a: "Alan Jackson",     t: "Chattahoochee" },
    { a: "Reba McEntire",    t: "Fancy" },
    { a: "Brooks & Dunn",    t: "Boot Scootin' Boogie" },
    { a: "Trisha Yearwood",  t: "She's in Love with the Boy" },
    { a: "Vince Gill",       t: "When I Call Your Name" },
    { a: "Toby Keith",       t: "Should've Been a Cowboy" },
    { a: "Keith Urban",      t: "You'll Think of Me" },
    { a: "Dierks Bentley",   t: "Come a Little Closer" },
    { a: "Jason Aldean",     t: "Big Green Tractor" },
    { a: "Blake Shelton",    t: "God Gave Me You" },
    { a: "Luke Bryan",       t: "Play It Again" },
    { a: "Florida Georgia Line", t: "Cruise" },
  ]},
  { id: "christmas", label: "Noël 🎄",       emoji: "🎅", bpm: 105, tracks: [
    ...
    { a: "Eartha Kitt",      t: "Santa Baby" },
    { a: "Kelly Clarkson",   t: "Underneath the Tree" },
    { a: "Justin Bieber",    t: "Mistletoe" },
    { a: "Burl Ives",        t: "Have a Holly Jolly Christmas" },
    { a: "Tony Bennett",     t: "The Christmas Waltz" },
    { a: "Harry Connick Jr", t: "It's Beginning to Look a Lot Like Christmas" },
  ]},
  { id: "bollywood", label: "Bollywood",     emoji: "🎭", bpm: 110, tracks: [
    ...
    { a: "A.R. Rahman",      t: "Roja" },
    { a: "Pritam",           t: "Gerua" },
    { a: "Amit Trivedi",     t: "Ik Bagal" },
    { a: "Badshah",          t: "Paagal" },
    { a: "Guru Randhawa",    t: "Slowly Slowly" },
    { a: "Sunidhi Chauhan",  t: "Desi Girl" },
    { a: "Yo Yo Honey Singh", t: "Blue Eyes" },
    { a: "Mika Singh",       t: "Saawan Mein Lag Gayee Aag" },
  ]},
  { id: "bossa",    label: "Bossa Nova",      emoji: "🌴", bpm: 130, tracks: [
    ...
    { a: "Jorge Ben",        t: "Mas Que Nada" },
    { a: "Elza Soares",      t: "Negra Maluca" },
    { a: "Nara Leão",        t: "Menininha" },
    { a: "Joyce Moreno",     t: "Clareana" },
    { a: "Ivan Lins",        t: "Madalena" },
    { a: "Gilberto Gil",     t: "Aquele Abraço" },
    { a: "Tom Zé",           t: "Toc Toc Toc" },
  ]},
  { id: "punk",     label: "Punk Rock",       emoji: "⚡", bpm: 160, tracks: [
    ...
    { a: "Black Flag",       t: "Rise Above" },
    { a: "Fugazi",           t: "Waiting Room" },
    { a: "Minor Threat",     t: "Straight Edge" },
    { a: "Bad Brains",       t: "I Against I" },
    { a: "Bikini Kill",      t: "Rebel Girl" },
    { a: "Sleater-Kinney",   t: "Dig Me Out" },
    { a: "The Minutemen",    t: "Corona" },
    { a: "X",               t: "Los Angeles" },
    { a: "GBH",              t: "Sick Boy" },
    { a: "Stiff Little Fingers", t: "Alternative Ulster" },
  ]},
  { id: "rnb2000s",  label: "2000s R&B",       emoji: "💎", bpm: 95, tracks: [
    ...
    { a: "Beyoncé",            t: "Crazy in Love" },
    { a: "Destiny's Child",    t: "Soldier" },
    { a: "Janet Jackson",      t: "All for You" },
    { a: "Brandy",             t: "What About Us?" },
    { a: "Monica",             t: "So Gone" },
    { a: "Eve",                t: "Let Me Blow Ya Mind" },
    { a: "Mariah Carey",       t: "Obsessed" },
    { a: "Fantasia",           t: "I Believe" },
    { a: "Jordin Sparks",      t: "No Air" },
    { a: "Keri Hilson",        t: "Knock You Down" },
    { a: "Ciara",              t: "1, 2 Step" },
    { a: "Bow Wow",            t: "Like You" },
  ]},
  { id: "hiphop2000s", label: "2000s Hip-Hop",  emoji: "🔥", bpm: 92, tracks: [
    ...
    { a: "Nelly",              t: "Hot in Herre" },
    { a: "Busta Rhymes",       t: "Touch It" },
    { a: "Fat Joe",            t: "Lean Back" },
    { a: "Ja Rule",            t: "Put It on Me" },
    { a: "Common",             t: "The Light" },
    { a: "Mos Def",            t: "Ms. Fat Booty" },
    { a: "Talib Kweli",        t: "Get By" },
    { a: "Dead Prez",          t: "Hip Hop" },
    { a: "Lil Jon",            t: "Get Low" },
    { a: "Chingy",             t: "Right Thurr" },
    { a: "Snoop Dogg",         t: "Beautiful" },
    { a: "Rick Ross",          t: "Push It" },
    { a: "Young Jeezy",        t: "Go Crazy" },
  ]},
  { id: "current",   label: "Current Hits",     emoji: "📱", bpm: 115, tracks: [
    ...
    { a: "Zach Bryan",         t: "Something in the Orange" },
    { a: "Noah Kahan",         t: "Stick Season" },
    { a: "Teddy Swims",        t: "Lose Control" },
    { a: "Morgan Wallen",      t: "Last Night" },
    { a: "Jelly Roll",         t: "Need a Favor" },
    { a: "Shaboozey",          t: "A Bar Song" },
    { a: "Doechii",            t: "Nissan Altima" },
    { a: "Chappell Roan",      t: "Pink Pony Club" },
    { a: "Gracie Abrams",      t: "Risk" },
    { a: "Måneskin",            t: "Beggin'" },
  ]},
  ...
  { id: "kids",     label: "Kids & Family",  emoji: "🧸", bpm: 100, tracks: [
    ...
    { a: "Carly Rae Jepsen", t: "Call Me Maybe" },
    { a: "Bruno Mars",       t: "The Lazy Song" },
    { a: "Katy Perry",       t: "Roar" },
    { a: "Taylor Swift",     t: "Shake It Off" },
    { a: "Mark Ronson",      t: "Uptown Funk" },
    { a: "Shawn Mendes",     t: "Treat You Better" },
    { a: "One Direction",    t: "What Makes You Beautiful" },
    { a: "The Black Eyed Peas", t: "I Gotta Feeling" },
  ]},
  { id: "neosoul",  label: "Neo-Soul",           emoji: "🕊️", bpm: 90, tracks: [
    ...
    { a: "Raphael Saadiq",    t: "Still Ray" },
    { a: "Anthony Hamilton",  t: "Charlene" },
    { a: "Tweet",             t: "Oops" },
    { a: "Floetry",           t: "Say Yes" },
    { a: "Dwele",             t: "Subject" },
    { a: "Toni Braxton",      t: "He Wasn't Man Enough" },
    { a: "Thundercat",        t: "Them Changes" },
    { a: "Steve Lacy",        t: "Bad Habit" },
    { a: "Meshell Ndegeocello", t: "Bitter" },
    { a: "Lalah Hathaway",    t: "Let Go" },
    { a: "Joe",               t: "All That I Am" },
    { a: "Amel Larrieux",     t: "Get Up" },
  ]},
  { id: "funk",     label: "Funk",               emoji: "🎺", bpm: 108, tracks: [
    ...
    { a: "Con Funk Shun",     t: "Ffun" },
    { a: "Bar-Kays",          t: "Too Hot to Stop" },
    { a: "Lakeside",          t: "Fantastic Voyage" },
    { a: "Dazz Band",         t: "Let It Whip" },
    { a: "Gap Band",          t: "You Dropped a Bomb on Me" },
    { a: "Midnight Star",     t: "Freak-A-Zoid" },
    { a: "Ohio Players",      t: "Love Rollercoaster" },
    { a: "Club Nouveau",      t: "Lean on Me" },
    { a: "Ready for the World", t: "Oh Sheila" },
    { a: "Zapp",              t: "Doo Wa Ditty" },
  ]},
  { id: "blues",    label: "Blues",              emoji: "🎸", bpm: 80, tracks: [
    ...
    { a: "Freddie King",      t: "The Stumble" },
    { a: "T-Bone Walker",     t: "T-Bone Shuffle" },
    { a: "Junior Wells",      t: "Hoodoo Man Blues" },
    { a: "Son House",         t: "Death Letter" },
    { a: "Lightnin' Hopkins", t: "Mojo Hand" },
    { a: "Guitar Slim",       t: "The Things That I Used to Do" },
    { a: "Luther Allison",    t: "Move from the Hood" },
    { a: "Keb' Mo'",          t: "Am I Wrong" },
    { a: "James Cotton",      t: "Dealing with the Devil" },
    { a: "Shemekia Copeland", t: "Ghetto Child" },
  ]},
  { id: "musicals", label: "Musicals",           emoji: "🎭", bpm: 112, answerMode: "title-only", singleLabel: "Song or Musical", tracks: [
    ...
    { a: "Fun Home Original Cast",   t: "Ring of Keys" },
    { a: "Spring Awakening Original Cast", t: "Mama Who Bore Me" },
    { a: "In the Heights Original Cast", t: "96,000" },
    { a: "Les Misérables Original Cast", t: "One Day More" },
    { a: "Cats Original Cast",        t: "Memory" },
    { a: "Anything Goes Original Cast", t: "You're the Top" },
    { a: "Billy Elliot Original Cast", t: "Electricity" },
    { a: "Kinky Boots Original Cast",  t: "Raise You Up" },
    { a: "Hadestown Original Cast",    t: "Wait for Me" },
  ]},
  { id: "tvthemes_classic", label: "Classic TV Themes", emoji: "📺", bpm: 100, artistLabel: "Show", artistPlaceholder: "Which TV show?", answerMode: "title-only", singleLabel: "Show Name", tracks: [
    ...
    { a: "Fred Steiner",      t: "Perry Mason Theme" },
    { a: "Hugo Montenegro",   t: "Man with No Name Theme" },
    { a: "Billy Goldenberg",  t: "Kojak Theme" },
    { a: "Jerry Goldsmith",   t: "The Man from U.N.C.L.E. Theme" },
    { a: "Jerry Fielding",    t: "The Outer Limits Theme" },
    { a: "Ray Evans",         t: "Bonanza Theme" },
    { a: "Billy May",         t: "The Flintstones Theme" },
    { a: "Hoyt Curtin",       t: "The Jetsons Theme" },
  ]},
  { id: "tvthemes_modern", label: "Modern TV Themes",  emoji: "🖥️", bpm: 108, artistLabel: "Show", artistPlaceholder: "Which TV show?", answerMode: "title-only", singleLabel: "Show Name", tracks: [
    ...
    { a: "Aimee Mann",        t: "One" },
    { a: "Cinematic Orchestra", t: "To Build a Home" },
    { a: "Bear McCreary",     t: "Black Sails Theme" },
    { a: "Cliff Martinez",    t: "Too Old to Die Young Theme" },
    { a: "Explosions in the Sky", t: "Friday Night Lights Theme" },
    { a: "Trent Reznor",      t: "Main Title Theme (Watchmen)" },
    { a: "Yo La Tengo",       t: "Ohm (The Sopranos)" },
    { a: "Andrew Lockington", t: "Yellowstone Theme" },
    { a: "Jeff Beal",         t: "House of Cards Theme" },
  ]},
  ...
  { id: "workout",  label: "Workout / Gym",      emoji: "💪", bpm: 140, tracks: [
    ...
    { a: "Black Eyed Peas",   t: "Pump It" },
    { a: "Lil Jon",           t: "Turn Down for What" },
    { a: "Swedish House Mafia", t: "Don't You Worry Child" },
    { a: "The Prodigy",       t: "Breathe" },
    { a: "Muse",              t: "Supermassive Black Hole" },
    { a: "Queens of the Stone Age", t: "No One Knows" },
    { a: "Audioslave",        t: "Like a Stone" },
    { a: "Bring Me the Horizon", t: "Can You Feel My Heart" },
    { a: "Knife Party",       t: "Bonfire" },
    { a: "Pendulum",          t: "Watercolour" },
    { a: "Hardwell",          t: "Spaceman" },
    { a: "Tiësto",            t: "Red Lights" },
    { a: "Deadmau5",          t: "Ghosts 'n' Stuff" },
    { a: "Slipknot",          t: "Before I Forget" },
  ]},
  { id: "lofi",     label: "Lo-fi / Chill",      emoji: "☕", bpm: 75, tracks: [
    ...
    { a: "Washed Out",        t: "Feel It All Around" },
    { a: "James Blake",       t: "Retrograde" },
    { a: "Shlohmo",           t: "Rained the Whole Time" },
    { a: "Baths",             t: "Indoorsy" },
    { a: "Clams Casino",      t: "I'm God" },
    { a: "Emancipator",       t: "Soon It Will Be Cold Enough" },
    { a: "Thievery Corporation", t: "Richest Man in Babylon" },
    { a: "Toro y Moi",        t: "Say That" },
    { a: "How to Dress Well", t: "And It Was U" },
  ]},
